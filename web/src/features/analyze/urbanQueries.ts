...
export const URBAN_DETECTION_QUERIES: UrbanQuery[] = [
  ...
  { query: "spray paint graffiti", situationHint: "grafiti" },
  { query: "colorful graffiti tags", situationHint: "grafiti" },
  { query: "wall vandalism paint", situationHint: "grafiti" },
  { query: "painted graffiti on building", situationHint: "grafiti" },
  { query: "blocked sidewalk", situationHint: "kaldirim_isgali" },
  { query: "obstacle on sidewalk", situationHint: "kaldirim_isgali" },
  { query: "coiled cable on sidewalk", situationHint: "kaldirim_isgali" },
  { query: "extension cord on ground", situationHint: "kaldirim_isgali" },
  { query: "hose on pavement", situationHint: "kaldirim_isgali" },
  { query: "stacked equipment on sidewalk", situationHint: "kaldirim_isgali" },
  { query: "construction materials on sidewalk", situationHint: "kaldirim_isgali" },
  { query: "abandoned items on sidewalk", situationHint: "cop_kirliligi" },
  { query: "debris on sidewalk", situationHint: "cop_kirliligi" },
